...
namespace UnityConfig
{
    ...
    extern const char* const UnityVersion = "2021.3.2f1";
    ...
    extern const char* const UnityVersionUnderHash = "2021.3.2f1_d6360bedb9a0";
    extern const char* const UnityVersionUnderHash_Verbose = "2021.3.2f1_d6360bedb9a0";
    extern const char* const UnityVersionUnderHash_WithParens = "2021.3.2f1 (d6360bedb9a0)";

    // A numeric representation of the version control hash
    extern const UInt64 UnityVersionBuild = 14038539;

    extern const UInt64 UnityVersionDate = 1651034133;
    extern const char* const UnityVersionBranch = "2021.3/staging";
    extern const char* const UnityVersionDisplay = "2021.3.2f1";
    extern const char* const UnityVersionDisplay_Verbose = "2021.3.2f1.110";
    extern const char* const UnityVersionRevision = "d6360bedb9a0";

    // Wide strings
    extern const wchar_t* const L_UnityVersionUnderHash_WithParens = L"2021.3.2f1 (d6360bedb9a0)";
    extern const wchar_t* const L_UnityVersion = L"2021.3.2f1";
}
    ...
    #define UNITY_VERSION_UNDER_HASH "2021.3.2f1_d6360bedb9a0"
    #define UNITY_VERSION_PARENS_HASH "2021.3.2f1 (d6360bedb9a0)"
    #define UNITY_VERSION_BLD 14038539
    #define UNITY_VERSION_WIN "2021.3.2.14038539"
